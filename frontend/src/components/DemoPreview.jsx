...
const previews = [
    {
        ...
        meta: "10 ROUNDS · MS PRECISION",
        desc: "Wait for the green. Don't jump the gun. Track your average reaction time across 10 randomized rounds, with false-start penalties.",
    },
    {
        key: "decision",
        to: "/games/decision",
        ...
        meta: "5 SCENARIOS · FREEZE FRAME",
        desc: "Striker under pressure, defender closing, teammate available. Pick the right action under time pressure — pass, shoot, or dribble.",
    },
    {
        key: "leaderboard",
        to: "/leaderboard",
